...
pmapath1="/var/www/html/phpmyadmin/config.inc.php"
#pmapath1="/etc/phpmyadmin/config.inc.php"
#pmapath2="/usr/share/phpmyadmin/config.sample.inc.php"
pmapath2="/var/www/html/phpmyadmin/config.sample.inc.php"
...
sed -i "18s/''/'12345678910111213141516171819200'/" /var/www/html/phpmyadmin/config.inc.php
...
if [ -e '/usr/bin/curl' ]; then
    curl -O -k -s https://raw.githubusercontent.com/skurudo/phpmyadmin-fixer/master/create_tables.sql;
    else
